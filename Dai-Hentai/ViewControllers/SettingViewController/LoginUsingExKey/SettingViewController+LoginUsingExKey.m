...
- (void)onLoginUsingExKeyPress {
    UIAlertController *loginCookieAlert = [UIAlertController alertControllerWithTitle:@"用Cookie登录" message:@"请在此处输入Cookie" preferredStyle:UIAlertControllerStyleAlert];
